...
export default {
  ...
  methods: {
    toggle: function () {
      this.expandBtnName = this.expandBtnName == "展开" ? "收起" : "展开";
      this.expandBtnIcon =
...
/* 媒体查询分辨率样式 小于1366分辨率  呈现一行占2个input 框 */
